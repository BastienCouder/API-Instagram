...
const FollowingProfile = () => {
  ...
  return (
    <MainLayout>
      <div className="flex flex bg-black h-screen w-screen items-start text-white">
        <div className="flex flex-col w-full h-full items-start sm:w-3/5 lg:w-2/5">
          <div className="w-full ">
            ...
            <IoMdReturnLeft
              ...
              className="cursor-pointer absolute sm:text-lg right-5 top-6"
            />
          </div>
