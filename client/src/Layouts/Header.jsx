      ...
      <ul className="flex flex-row justify-evenly w-full sm:flex-col gap-2 sm:gap-4 sm:ms-3 sm:me-4 sm:ms-4 text-2xl">
        <NavLink to="/">
          <li className="flex items-center w-full me-4 ps-4 py-3 rounded-2xl hover:bg-blackHover">
            <AiFillHome />
            <span className="ms-4 text-base sm:block hidden">Accueil</span>
          </li>
        </NavLink>
        <NavLink to="/search">
          <li className="flex items-center w-full me-4  ps-4 py-3 rounded-2xl hover:bg-blackHover">
            <BiSearch />
            <span className="ms-4 text-base sm:block hidden">Rechercher</span>
          </li>
        </NavLink>
        {uid ? (
          <NavLink to="/new-post">
        ...
        <NavLink to="/profil">
          <li className="flex items-center w-full me-4 ps-4  py-3 rounded-2xl hover:bg-blackHover">
            <FaUserCircle />
            <span className="ms-4 text-base sm:block hidden">Profil</span>
          </li>
        </NavLink>
        {uid ? (
          <NavLink to="/">
